                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <select class="form-select" id="select3">
                                                    ...
                                                    <option value="5">View Moutain Room</option>
                                                </select>
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <select class="form-select" id="select3">
                                                    ...
                                                    <option value="3">Airport shuttle</option>
                                                    <option value="4">Food & Restaurant</option>
                                                    <option value="5">Bike rental</option>
                                                    <option value="6">Motorbike rental</option>
                                                    <option value="7">Gym</option>
                                                    <option value="8">Bar</option>
                                                    <option value="9">Room & Apartment</option>
                                                </select>
                                                <label for="select3">Select A Service</label>
                                            </div>
                                        </div>
